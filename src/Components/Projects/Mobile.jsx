    ...
    <div className="Projects">
      <div className="Projects-left">
        <div className="Projects-left_item">
          <p className={active === "social" ? "Projects-title_active" : "Projects-title"} onClick={() => setActive('social')}>Social App</p>
        </div>
        <div className="Projects-left_item">
          <p className={active === "groundbnb" ? "Projects-title_active" : "Projects-title"} onClick={() => setActive('groundbnb')}>GroundBnb</p>
        </div>
        <div className="Projects-left_item">
          <p className={active === "wikidocs" ? "Projects-title_active" : "Projects-title"} onClick={() => setActive('wikidocs')}>WikiDocs</p>
        </div>
      </div>
