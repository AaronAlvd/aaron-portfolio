...
export default function Mobile() {
  ...
  return ( 
    <div className="Skills" style={{minHeight: `${height - 160}px`}}>
      <div className="Skills-left_div">
        <div className="Skills-div_name">
          <p className={active === 'all' ? "Skills-name_active" : "Skills-name"} onClick={() => setActive('all')}>All</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'languages' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('languages')}>Languages</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'web' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('web')}>Web</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'frontend' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('frontend')}>Frontend</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'backend' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('backend')}>Backend</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'database' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('database')}>Database</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'api' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('api')}>API</p>
        </div>

        <div className="Skills-div_name">
          <p className={active === 'tools' ? "Skills-name_active" : "Skills-name"}  onClick={() => setActive('tools')}>Tools</p>
        </div>
      </div>

      <div className="Skills-right_div">
